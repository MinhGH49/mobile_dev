 ...
 * Use the {@link AvatarDialogFragment#newInstance} factory method to
...
public class AvatarDialogFragment extends DialogFragment {
    ...
    public static AvatarDialogFragment newInstance(int dialog_id) {
        AvatarDialogFragment frag = new AvatarDialogFragment();
